    ...
    UserDataPtr user_data)
{
   ...
   else
   {
      ...
      values[idx++] = pow(x[0], 2) * ((((2 * c_ * pow(R_, 2) * x[37] / (m_ * pow(x[10], 3))) + (2 * x[19] * x[37] / pow(x[10], 2)) - (2 * kt_ * R_ * x[46] / (m_ * pow(x[10], 3))) + (g_ * cos(x[28]) / pow(x[10], 2))) / (1 + pow(J_*R_, 2)/(m_*x[10]))) + (pow(J_*R_, 2) * B1 / (m_ * (1 + pow(J_*R_, 2)/(m_*x[10])) * pow(x[10], 2)))) / 768;   // (row+2, 10)
      values[idx++] = pow(x[0], 2) * (0 - ((2 * c_ * pow(R_, 2) * x[38] / (m_ * pow(x[11], 3))) + (2 * x[20] * x[39] / pow(x[11], 2)) - (2 * kt_ * R_ * x[48] / (m_ * pow(x[11], 3)) + (g_ * cos(x[29] / pow(x[11], 2)))) / (1 + pow(J_*R_, 2)/(m_*x[11]))) - (pow(J_*R_, 2) * B2 / (m_ * (1 + pow(J_*R_, 2)/(m_*x[11])) * pow(x[11], 2)))) / 768; // (row+2, 11)
